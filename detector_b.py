...
def main():
  ...
  for dev in devlist:
    ...
    # Log
    sql = "INSERT INTO history (id, name, type, scantime, sensor) VALUES (%s, %s, %s, %s, 'b')"
    c.execute(sql, (mac, name, type, scantime)) 

    # Device
    sql = "INSERT INTO devices (id, name, service, major, minor, lastseen, b_seen) VALUES (%s, %s, %s, %s, %s, %s, %s) ON DUPLICATE KEY UPDATE name = VALUES(name), service = VALUES(service), major = VALUES(major), minor = VALUES(minor), lastseen = VALUES(lastseen), b_seen = VALUES(b_seen)"
